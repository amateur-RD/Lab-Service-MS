...
<%
String id=codeToString(request.getParameter("yjid"));
String sbid=codeToString(request.getParameter("sbid"));
String wzid=codeToString(request.getParameter("wzid"));
String yjbh=codeToString(request.getParameter("yjbh"));
String yjip=codeToString(request.getParameter("yjip"));
String yjzt=codeToString(request.getParameter("yjzt"));
