...
<% 
int rtn=stmt.executeUpdate("update preventivenotes set hsid='"+yjid+"',infoid='"+rjazxxid+"',origin='"+wtly+"',date='"+whrq+"',phenomenon='"+xx+"' ,solution='"+jjfa+"',userid='"+yhid+"'where noteid="+id+"");
