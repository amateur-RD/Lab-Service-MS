...
String tjwtz=(String)session.getAttribute("tjwtz");
String tjsj=(String)session.getAttribute("tjsj");
String sysmc=(String)session.getAttribute("sysmc");
String rjmc=(String)session.getAttribute("rjmc");
String xtmc=(String)session.getAttribute("xtmc");
String gzyjbh=(String)session.getAttribute("gzyjbh");
String wtzt=(String)session.getAttribute("wtzt");
String wtlx=(String)session.getAttribute("wtlx");
