...
String sql1="select  count(*) as total from hardsoft";
ResultSet rs1=stmt.executeQuery(sql1);
rs1.next();
int total=rs1.getInt("total"); 
String sql="select  * from hardsoft ";
...
{out.println("<td class='STYLE22'><div align='center'><a href=yjxyy.jsp?list_notice="+ (list_notice+1) +"  height='15'>[下一页]</div></td></a>") ;}                   
if(list_notice > 1)
{out.println("<td class='STYLE22'><div align='center'><a href=yjsyy.jsp?list_notice="+ (list_notice-1) +"  height='15'>[上一页]</div></td></a>") ;}
out.println("<td class='STYLE22'><div align='center'><a href=yjsy.jsp?list_notice="+1+"  height='15'>『首页』</div></td></a>") ;
out.println("<td class='STYLE22'><div align='center'><a href=yjwy.jsp?list_notice="+pageCount+"  height='15'>『尾页』</div></td></a>") ;
%>
            ...
            <td width="30" class="STYLE22"><input type="button" onClick="yjzd();" value="确定" width="20" height="15" /></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
