...
<div class="bs-docs-example">
            <form class="bs-docs-example form-horizontal" action="sbssh.jsp">
            <div class="control-group error">
              <label for="inputError" class="control-label">设备ＩＤ</label>
              <div class="controls">
                <input type="text" name="sbid">
              </div>
            </div>
            <div class="control-group info">
              <label for="inputInfo" class="control-label">设备名称</label>
              <div class="controls">
                <input type="text" name="sbmc">
              </div>
            </div>
            <div class="control-group success">
              <label for="inputSuccess" class="control-label">设备类型</label>
              <div class="controls">
              ...
              <div class="control-group error">
              <label for="inputError" class="control-label">设备细节</label>
              <div class="controls">
                <input type="text" name="sbxj">
              </div>
            </div>
            <div class="control-group info">
              <label for="inputInfo" class="control-label">时间</label>
              <div class="controls">
                <input type="text" name="sbsj">
              </div>
            </div>
            <div class="control-group info">
              <label for="inputInfo" class="control-label">设备数量</label>
              <div class="controls">
                <input type="text" name="sbsl">
              <br>
            </div>
            <br>
