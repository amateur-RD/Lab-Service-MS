...
document.form1.submit();}
function jlsc()
{ document.form1.action="jlxx.jsp";
document.form1.submit();}
function jlzd()
...
{out.println("<td class='STYLE22'><div align='center'><a href=jlxx.jsp?list_notice="+ (list_notice+1) +"  height='15'>[下一页]</div></td></a>") ;}                   
if(list_notice > 1)
{out.println("<td class='STYLE22'><div align='center'><a href=jlxx.jsp?list_notice="+ (list_notice-1) +"  height='15'>[上一页]</div></td></a>") ;}
out.println("<td class='STYLE22'><div align='center'><a href=jlxx.jsp?list_notice="+1+"  height='15'>『首页』</div></td></a>") ;
out.println("<td class='STYLE22'><div align='center'><a href=jlxx.jsp?list_notice="+pageCount+"  height='15'>『尾页』</div></td></a>") ;
%>
            ...
            <td width="30" class="STYLE22"><input type="button" onClick="jlzd();" value="确定" width="20" height="15" /></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
...
if(id==null)
{%> <script>alert("请选择要删除的对象！");window.location="jlxx.jsp";</script> <%}
else{
for(int j=0;j<id.length;j++)
{
   int rtn=stmt.executeUpdate("delete from preventivenotes where noteid="+id[j]+"");
}
%> <script>alert("删除成功！");window.location="jlxx.jsp";</script> <%
} 
}
 %>
</body>
