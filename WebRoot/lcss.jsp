...
<div class="bs-docs-example">
            <form class="bs-docs-example form-horizontal" action="search.jsp">
            <div class="control-group error">
              <label for="inputError" class="control-label">教室名称</label>
              <div class="controls">
                <input type="text" name="locname">
              </div>
            </div>
            <div class="control-group info">
              <label for="inputInfo" class="control-label">节次</label>
              <div class="controls">
                <input type="text" name="sbmc">
              </div>
            </div>
            <div class="control-group success">
              <label for="inputSuccess" class="control-label">使用时间</label>
              <div class="controls">
