...
<div class="bs-docs-example">
            <form class="bs-docs-example form-horizontal" action="xtssh.jsp">
            <div class="control-group error">
              <label for="inputError" class="control-label">系统ＩＤ</label>
              <div class="controls">
                <input type="text" name="xtid">
              </div>
            </div>
            <div class="control-group info">
              <label for="inputInfo" class="control-label">系统名称</label>
              <div class="controls">
                <input type="text" name="xtmc">
              </div>
            </div>
            <div class="control-group success">
              <label for="inputSuccess" class="control-label">系统类型</label>
              <div class="controls">
                <input type="text" name="xtlx">
