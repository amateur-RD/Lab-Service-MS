...
document.form1.submit();}
function rjsszd()
{ document.form1.action="rjsszd.jsp";
document.form1.submit();}
function checkAll()
{
...
String rjmc=(String)session.getAttribute("rjmc");
String rjlx=(String)session.getAttribute("rjlx");
String id=(String)session.getAttribute("id");

session.setAttribute("id",id);
session.setAttribute("rjmc",rjmc);
session.setAttribute("rjlx",rjlx);
...
if(id==null&&rjmc==null&&rjlx==null)
sql1="select  count(*) as total from soft ";
if(id!=null)
sql1="select  count(*) as total from soft where sid like '%"+id+"%'";
if(rjmc!=null)
{
if(id!=null)
sql1=sql1.concat("  and sname like '%"+rjmc+"%'");
else
sql1=sql1.concat("  where sname like '%"+rjmc+"%'");
}
if(rjlx!=null)
{
if(!(id==null&&rjmc==null))
sql1=sql1.concat("  and stype like '%"+rjlx+"%'");
else
sql1=sql1.concat("  where stype like '%"+rjlx+"%'");
}
...
if(id!=null)
sql="select  * from soft where sid like '%"+id+"%'";
if(rjmc!=null)
{
if(id!=null)
sql=sql.concat("  and sname like '%"+rjmc+"%'");
else
sql=sql.concat("  where sname like '%"+rjmc+"%'");
}
if(rjlx!=null)
{
if(!(id==null&&rjmc==null))
sql=sql.concat("  and stype like '%"+rjlx+"%'");
else
sql=sql.concat("  where stype like '%"+rjlx+"%'");
}
...
int i=0;  
%>   	
<%if(total==0&&!(id==null&&rjmc==null&&rjlx==null)) 
{response.sendRedirect("rjss.jsp?sb=0");
 }else{ %>
...
{out.println("<td class='STYLE22'><div align='center'><a href=rjssy.jsp?list_notice="+ (list_notice+1) +"  height='15'>[下一页]</div></td></a>") ;}                   
if(list_notice > 1)
{out.println("<td class='STYLE22'><div align='center'><a href=rjssy.jsp?list_notice="+ (list_notice-1) +"  height='15'>[上一页]</div></td></a>") ;}
out.println("<td class='STYLE22'><div align='center'><a href=rjssy.jsp?list_notice="+1+"  height='15'>『首页』</div></td></a>") ;
out.println("<td class='STYLE22'><div align='center'><a href=rjssy.jsp?list_notice="+pageCount+"  height='15'>『尾页』</div></td></a>") ;
%>
            ...
            <td width="35"><input type="button" onClick="rjsszd();" value="确定" width="26" height="15" /></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
