...
/* 用于表达的样式 E */
  ...
  <form class="bs-docs-example form-horizontal" action="xttj.jsp">   
  <table class="table table-bordered">
              <tbody>
                <tr onMouseOver="this.style.background='E7F1FA'" onMouseOut="this.style.background=''">
                  <td width="4%">1</td>
                  <td width="15%">系统名称</td>
                  <td width="30%"><input type="text" name="xtmc" required></td>
                </tr>
                <tr onMouseOver="this.style.background='E7F1FA'" onMouseOut="this.style.background=''">
                  <td width="4%">2</td>
                  <td width="15%">系统类型</td>
                  <td width="30%"><select name="xtlx">
                  <option value="windows 98">windows 98</option>
                  <option value="windows xp">windows xp</option>
                  <option value="windows 7">windows 7</option>
                  <option value="windows 8">windows 8</option>
                  <option value="Linux">Linux</option></td>
                </tr>
                  <tr><td colspan="3">
            <ul class="pager">
         ...
         <% 
            ...
            if(xtmc!=null){
            String xtlx=Tools.toChinese(request.getParameter("xtlx"));
            int rtn=stmt.executeUpdate("insert into system(sysname,systype) values('"+Tools.toChinese(xtmc)+"','"+xtlx+"')");
            out.print("<script>alert('添加成功！');window.location='1xtxx.jsp';</script>");
            }
            %>
         </html>
