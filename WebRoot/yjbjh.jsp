...
String eqid1=codeToString(request.getParameter("sbid"));
String locid1=codeToString(request.getParameter("wzid"));
String hsnumber1=codeToString(request.getParameter("yjbh"));
String hsip1=codeToString(request.getParameter("yjip"));
String hsstate1=codeToString(request.getParameter("yjzt"));
%>
...
int rtn=stmt.executeUpdate("update hardsoft set eqid='"+eqid1+"',locid='"+locid1+"',hsnumber='"+hsnumber1+"',hsip='"+hsip1+"',hsstate='"+hsstate1+"' where hsid="+id+"");
