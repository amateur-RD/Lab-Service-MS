...
<%
String id=codeToString(request.getParameter("xxid"));
String yjid=codeToString(request.getParameter("yjid"));
String xtid=codeToString(request.getParameter("xtid"));
String rjid=codeToString(request.getParameter("rjid"));
String azsj=codeToString(request.getParameter("azsj"));
String yhid=codeToString(request.getParameter("yhid"));
session.setAttribute("id",id);
session.setAttribute("yjid",yjid);
session.setAttribute("xtid",xtid);
session.setAttribute("rjid",rjid);
session.setAttribute("azsj",azsj);
...
document.form1.submit();}
function rjazsszd()
{ document.form1.action="rjazsszd.jsp";
document.form1.submit();} 
function sel(a)
{
...
if(id==null&&yjid==null&&xtid==null&&rjid==null&&azsj==null&&yhid==null)
sql1="select  count(*) as total from softinstall ";
if(id!=null)
sql1="select  count(*) as total from softinstall where infoid like '%"+id+"%'";
if(yjid!=null)
{
if(id!=null)
sql1=sql1.concat("  and hsid like '%"+yjid+"%'");
else
sql1=sql1.concat("  where hsid like '%"+yjid+"%'");
}
if(xtid!=null)
{
if(!(id==null&&yjid==null))
sql1=sql1.concat("  and sysid like '%"+xtid+"%'");
else
sql1=sql1.concat("  where sysid like '%"+xtid+"%'");
}
if(rjid!=null)
{
if(!(id==null&&yjid==null&&xtid==null))
sql1=sql1.concat(" and sid like '%"+rjid+"%'");
else
sql1=sql1.concat(" where sid like '%"+rjid+"%'");
}
if(azsj!=null)
{
if(!(id==null&&yjid==null&&xtid==null&&rjid==null))
sql1=sql1.concat("  and time like '%"+azsj+"%'");
else
sql1=sql1.concat("  where time like '%"+azsj+"%'");
}
if(yhid!=null)
{
if(!(id==null&&yjid==null&&xtid==null&&rjid==null&&azsj==null))
...
if(id==null&&yjid==null&&xtid==null&&rjid==null&&azsj==null&&yhid==null)
sql="select  * as total from softinstall ";
if(id!=null)
sql="select  * from softinstall where infoid like '%"+id+"%'";
if(yjid!=null)
{
if(id!=null)
sql=sql.concat("  and hsid like '%"+yjid+"%'");
else
sql=sql.concat("  where hsid like '%"+yjid+"%'");
}
if(xtid!=null)
{
if(!(id==null&&yjid==null))
sql=sql.concat("  and sysid like '%"+xtid+"%'");
else
sql=sql.concat("  where sysid like '%"+xtid+"%'");
}
if(rjid!=null)
{
if(!(id==null&&yjid==null&&xtid==null))
sql=sql.concat(" and sid like '%"+rjid+"%'");
else
sql=sql.concat(" where sid like '%"+rjid+"%'");
}
if(azsj!=null)
{
if(!(id==null&&yjid==null&&xtid==null&&rjid==null))
sql=sql.concat("  and time like '%"+azsj+"%'");
else
sql=sql.concat("  where time like '%"+azsj+"%'");
}
if(yhid!=null)
{
if(!(id==null&&yjid==null&&xtid==null&&rjid==null&&azsj==null))
...
%>   
<%if(total==0&&!(id==null&&yjid==null&&xtid==null&&rjid==null&&azsj==null&&yhid==null)) 
{response.sendRedirect("rjazss.jsp?sb=0");
 }else{ %>
...
{out.println("<td class='STYLE22'><div align='center'><a href=rjazssy.jsp?list_notice="+ (list_notice+1) +"  height='15'>[下一页]</div></td></a>") ;}                   
if(list_notice > 1)
{out.println("<td class='STYLE22'><div align='center'><a href=rjazssy.jsp?list_notice="+ (list_notice-1) +"  height='15'>[上一页]</div></td></a>") ;}
out.println("<td class='STYLE22'><div align='center'><a href=rjazssy.jsp?list_notice="+1+"  height='15'>『首页』</div></td></a>") ;
out.println("<td class='STYLE22'><div align='center'><a href=rjazssy.jsp?list_notice="+pageCount+"  height='15'>『尾页』</div></td></a>") ;
%>
            ...
            <td width="30" class="STYLE22"><input type="button" onClick="rjazsszd();" value="确定" width="20" height="15" /></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
