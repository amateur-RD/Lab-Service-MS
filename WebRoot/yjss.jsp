...
<div class="bs-docs-example">
            <form class="bs-docs-example form-horizontal" action="yjssh.jsp">
            <div class="control-group error">
              <label for="inputError" class="control-label">硬件ＩＤ</label>
              <div class="controls">
                <input type="text" name="yjid">
              </div>
            </div>
            <div class="control-group info">
              <label for="inputInfo" class="control-label">设备ＩＤ</label>
              <div class="controls">
                <input type="text" name="sbid">
              </div>
            </div>
            <div class="control-group success">
              <label for="inputSuccess" class="control-label">位置ＩＤ</label>
              <div class="controls">
              ...
              <div class="control-group error">
              <label for="inputError" class="control-label">硬件编号</label>
              <div class="controls">
                <input type="text" name="yjbh">
              </div>
            </div>
            <div class="control-group info">
              <label for="inputInfo" class="control-label">硬件ＩＰ</label>
              <div class="controls">
                <input type="text" name="yjip">
              </div>
            </div>
            <div class="control-group info">
              <label for="inputInfo" class="control-label">硬件状态</label>
              <div class="controls">
                <input type="text" name="yjzt">
              <br>
            </div>
            <br>
