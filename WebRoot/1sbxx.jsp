...
document.form1.submit();}
function sbsc()
{ document.form1.action="1sbxx.jsp";
document.form1.submit();}
function sbzd()
...
if(id==null)
{%> <script>alert("请选择要删除的对象！");window.location="1sbxx.jsp";</script> <%}
else{
for(int j=0;j<id.length;j++)
{
   int rtn=stmt.executeUpdate("delete from equipment where eqid='"+id[j]+"'");
}
%> <script>alert("删除成功！");window.location="1sbxx.jsp";</script> <%
} 
}
  %>
</body>
