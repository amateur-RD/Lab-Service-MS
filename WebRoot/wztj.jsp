...
/* 用于表达的样式 E */
  ...
  <form class="bs-docs-example form-horizontal" action="wztjh.jsp">   
  <table class="table table-bordered">
              <tbody>             
                ...
                <tr onMouseOver="this.style.background='E7F1FA'" onMouseOut="this.style.background=''">
                  ...
                  <td width="30%"><input type="text" name="syskj" >平方米</td>
                </tr>
                <tr onMouseOver="this.style.background='E7F1FA'" onMouseOut="this.style.background=''">
                  <td width="4%">3</td>
                  <td width="15%" height="78">实验室描述</td>
                  <td width="30%"><textarea name="sysms" rows="10" cols="30" ></textarea></td>
                </tr>
                 <tr><td colspan="3">
            <ul class="pager">
