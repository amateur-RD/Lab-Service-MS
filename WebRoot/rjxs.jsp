...
%>     
   <form class="bs-docs-example form-horizontal" action="1rjxx.jsp">   
  <table class="table table-bordered">
              <tbody>
                ...
                <tr onMouseOver="this.style.background='E7F1FA'" onMouseOut="this.style.background=''">
                  ...
                  <td width="15%">软件名称：</td>
                  <td width="55%"><%=sname %></td>
                </tr>
                <tr onMouseOver="this.style.background='E7F1FA'" onMouseOut="this.style.background=''">
                
                  <td width="15%">软件类型：</td>
                  <td width="55%"><%=stype %></td>
                </tr>
                <tr onMouseOver="this.style.background='E7F1FA'" onMouseOut="this.style.background=''">
                 
                  <td width="15%" height="78">软件使用说明：</td>
                  <td width="55%"><%=sinstruction %></td>
                </tr>
               <tr onMouseOver="this.style.background='E7F1FA'" onMouseOut="this.style.background=''">
                  <td width="15%" height="25">教程文档下载：</td>
                  <td width="55%">
                 <a href="download.jsp?id=<%=sfile%>">点此下载</a></td>
                </tr>
                <tr><td colspan="3">
                <ul class="pager">
              <li><input type="submit" value="返回"></li>
            </ul>
                </td></tr>
              </tbody>
         </table>    
