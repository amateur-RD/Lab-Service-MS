...
String sql="select  * from system where sysid="+id+"";
ResultSet rs=stmt.executeQuery(sql);
rs.next();
String sysname=rs.getString("sysname");
String systype=rs.getString("systype");
%>     
  <form class="bs-docs-example form-horizontal" action="xtbjh.jsp">   
  <table class="table table-bordered">
              <tbody>
                ...
                <tr onMouseOver="this.style.background='E7F1FA'" onMouseOut="this.style.background=''">
                  <td width="4%">2</td>
                  <td width="15%">系统类型</td>
                  <td width="30%"><input type="text" name="xtlx" value="<%=systype %>"></td>
                </tr>
                  <tr><td colspan="3">
            <ul class="pager">
