...
String syskj=Tools.toChinese(request.getParameter("syskj"));
String sysms=Tools.toChinese(request.getParameter("sysms"));
%>
...
<% 
int rtn=stmt.executeUpdate("insert into location(locname,locspace,locdescription) values('"+sysmc+"','"+syskj+"','"+sysms+"')");
