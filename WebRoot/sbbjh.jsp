...
<%
String id=codeToString(request.getParameter("sbid"));
String sbmc=codeToString(request.getParameter("sbmc"));
String sblx=codeToString(request.getParameter("sblx"));
String sbxj=codeToString(request.getParameter("sbxj"));
String sj=(request.getParameter("sj"));
String sbsl=codeToString(request.getParameter("sbsl"));
%>
...
document.form1.submit();}
function sbzd()
{ document.form1.action="sbzd.jsp";
document.form1.submit();} 
function sel(a)
{
...
<% 
int rtn=stmt.executeUpdate("update equipment set eqname='"+sbmc+"',eqtype='"+sblx+"',eqdetail='"+sbxj+"',eqtime='"+sj+"' ,eqnum='"+sbsl+"' where eqid="+id+"");
...
{out.println("<td class='STYLE22'><div align='center'><a href=1sbxx.jsp?list_notice="+ (list_notice+1) +"  height='15'>[下一页]</div></td></a>") ;}                   
if(list_notice > 1)
{out.println("<td class='STYLE22'><div align='center'><a href=1sbxx.jsp?list_notice="+ (list_notice-1) +"  height='15'>[上一页]</div></td></a>") ;}
out.println("<td class='STYLE22'><div align='center'><a href=1sbxx.jsp?list_notice="+1+"  height='15'>『首页』</div></td></a>") ;
out.println("<td class='STYLE22'><div align='center'><a href=1sbxx.jsp?list_notice="+pageCount+"  height='15'>『尾页』</div></td></a>") ;
%>
            ...
            <td width="30" class="STYLE22"><input type="button" onClick="sbzd();" value="确定" width="20" height="15" /></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
