...
/* 用于表达的样式 E */
    		...
    		<div class="bs-docs-example">
                      <form class="bs-docs-example form-horizontal" action="rjssh.jsp">
            <div class="control-group error">
              <label for="inputError" class="control-label">软件ＩＤ</label>
              <div class="controls">
            ...
            <div class="control-group success">
              <label for="inputSuccess" class="control-label">软件类型</label>
              <div class="controls">
                <input type="text" name="rjlx">
                <br>
              </div>
              <br>
              <div class="control-group success">
